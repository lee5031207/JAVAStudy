...
public class Run {
	...
	public static void main(String[] args) {
		...
		studentList2.add(new Student("박준범",18));
		studentList2.add(new Student("박준범",20));
		studentList2.add(new Student("왕상준",22));
		studentList2.add(new Student("조하나",17));
		studentList2.add(new Student("천지영",19));
		studentList2.add(new Student("유연수",20));
		studentList2.add(new Student("김승현",24));
		studentList2.add(new Student("김수현",26));
		
		
		System.out.println("============문자열 오름차순전============================");
