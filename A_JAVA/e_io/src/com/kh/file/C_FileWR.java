...
public class C_FileWR {
	...
	public void fileOut() {
		...
		try {
			...
			fw.write(contents);
			System.out.println("파일 생성이 완료되었습니다. 프로젝트를 새로 고침하시오");
		} catch (IOException e) {
	...
	public void fileIn() {
		...
		//AutoCloseable 인터페이스를 구현한 객체만 try-with-resources문에서 사용 가능
		//try-with-resources문이 종료될 때
		//resource header에서 선언한 객체의 close메서드를 자동으로 호출
